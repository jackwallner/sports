...
/// On-device record of how someone met Sideline Pro before they bought it: which
...
public enum ConversionDiagnostics {
    private static let logger = Logger(subsystem: "com.jackwallner.sports", category: "Conversion")
    ...
    private static let impressionPrefix = "sideline_"

    /// Overridable so tests get their own suite instead of stamping on the real
    /// counters in the shared container.
    public nonisolated(unsafe) static var defaultsOverride: UserDefaults?
    ...
    public static func surface(fromImpressionID id: String) -> String {
    ...
    public static func recordPitchView(impressionID: String) {
    ...
    public static var totalPitchViews: Int { defaults.integer(forKey: Key.totalViews) }
    public static var lastSurface: String? { defaults.string(forKey: Key.lastSurface) }
    public static var appOpens: Int { defaults.integer(forKey: Key.appOpens) }

    public static var firstSeenDate: Date? {
    ...
    public static var viewsBySurface: [String: Int] {
    ...
    public static var subscriberAttributes: [String: String] {
